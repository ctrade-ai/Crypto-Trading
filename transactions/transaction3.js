...
async function transaction3(
    ...
    try {
        ...
        if (executionResponse.status === ORDER_STATUS.FILLED) {
            ...
            return transaction4(newTransactionDetail, executionResponse.executedQty);
            ...
            return Promise.allSettled([
                ...
                transaction4(newTransactionDetail, executedQty).catch(error => handleSubProcessError(error, newTransactionDetail, FUNCTION_INDEX, executedQty))
            ]);
